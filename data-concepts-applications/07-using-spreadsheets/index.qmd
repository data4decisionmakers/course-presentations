...
## "The best tool is the one you have" {.center background-color="#002147"}
...
## 4. No empty cell {.center}

![](../../images/no_empty_cell.jpg){fig-align="center"}

## 5. Put just one thing in a cell {.center}

* The cells in your spreadsheet should each contain one piece of data.

* Do not put more than one thing in a cell.

## 6. Make it a rectangle {.center}

![](../../images/non_rectangular_layout.jpg){fig-align="center"}

## 7. Create a data dictionary {.center}

![](../../images/data_dictionary.jpg){fig-align="center"}

## 8. No calculations in the raw data file {.center}

## 9. Do not use font colour or highlighting as data {.center}

![](../../images/no_color_formatting.jpg){fig-align="center"}

## 10. Make backups {.center}

## 11. Use data validation to avoid errors {.center}

We discuss validity errors specifically later in this slide deck.

## 12. Save the data in plain text files {.center}
...
![](../../images/spreadsheet01.png){fig-align="center"}

## Multiple variables are stored in one column

![](../../images/spreadsheet02.png){fig-align="center"}
