...
* Correlation - Spearman's rank correlation or Spearman's rho ($\rho$)

* Correlation - Kendall's tau ($\tau$) correlation
...
* Calculate tau ($\tau$) coefficient

$$ \tau ~ = ~ \frac{n_{concordant} - n_{discordant}}{\frac{n(n-1)}{2}}   $$

## Kendall's Rank Correlation - interpretation
