...
Using a template spreadsheet for data entry and a template spreadsheet containing data based on the data entry format, organise these files based on what we have discussed.
